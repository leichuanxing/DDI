    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('real_name', models.CharField(blank=True, max_length=64, verbose_name='真实姓名')),
                ('mobile', models.CharField(blank=True, max_length=32, verbose_name='手机号')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
        ...
        migrations.AddField(
            model_name='role',
            name='permissions',
            field=models.ManyToManyField(related_name='roles', through='accounts.RolePermission', to='accounts.permission', verbose_name='权限'),
        ),
        migrations.CreateModel(
            name='UserRole',
            fields=[
